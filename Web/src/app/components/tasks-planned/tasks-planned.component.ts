...
@Component({
  selector: 'app-tasks-planned',
  templateUrl: './tasks-planned.component.html',
  styleUrls: ['./tasks-planned.component.scss']
})
export class TasksPlannedComponent implements OnInit {
