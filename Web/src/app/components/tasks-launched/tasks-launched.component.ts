...
@Component({
  selector: 'app-tasks-launched',
  templateUrl: './tasks-launched.component.html',
  styleUrls: ['./tasks-launched.component.scss']
})
export class TasksLaunchedComponent implements OnInit {
