...
@Component({
  selector: 'app-tasks-under-consideration',
  templateUrl: './tasks-under-consideration.component.html',
  styleUrls: ['./tasks-under-consideration.component.scss']
})
export class TasksUnderConsiderationComponent implements OnInit {
